...
<body>
    ...
    <div class="container">
        <form class="login-form" action="/tcc_senai/configurations/process.php" method="post">
            ...
            <div class="cargo-buttons">
                ...
                <button type="button" class="cargo-button" id="manutencao-button" onclick="setCargo('Manutenção', 'manutencao-button')">Manutenção</button>
            </div>
    ...
    <script>
        ...
        // Remover a função handleRegister, pois o formulário agora será enviado normalmente
    </script>
</body>
</html>
